...
from django.contrib.auth import views as auth_views  # Import auth_views from Django
...
urlpatterns = [
    ...
    path('dockout/', auth_views.LogoutView.as_view(next_page='home'), name='dockout'),  # Use auth_views.LogoutView
]
